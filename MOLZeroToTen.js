...
function zeroToTen() {
    function playGame() {
        alert("Welcome to more or less.. This game is simple. Your mission is to find the randomly generated number between 0 and 10. You only have 5 attempts to find the correct number. Good luck!");
...

        {
            ...
            while (playGame && counter != maxAttempts) {
                ...
                let userInput = prompt(`Guess the number between 0 and 10. ${maxAttempts - counter} attempts remaining`);
